"""
This script is used to classify images into 'norm_beauty' and 'divers' categories using the LLAVA model based on the image only.
"""
import os
import json
import torch
...
RESULT_JSON_PATH = (
    "../llava_results/missing_prompt_2_cust_img_norm_beauty.json"
)
...
def main():
    ...
    for file in tqdm(image_files, desc="Processing Images"):
        ...
        with Image.open(image_path) as image:
            ...
            results[image_id] = {"id": image_id, "model": description}
